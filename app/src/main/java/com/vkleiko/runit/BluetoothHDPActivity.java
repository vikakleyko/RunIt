...
/**
 * Created by Neava on 2016-11-25.
 */
public class BluetoothHDPActivity extends AppCompatActivity {

    private static final String TAG = BluetoothHDPActivity.class.getSimpleName();
            ...
            switch (msg.what) {
                ...
                case BluetoothHDPService.STATUS_HEALTH_APP_REG:
                    mStatusMessage.setText(
                            String.format(mRes.getString(com.vkleiko.runit.R.string.status_reg),
                                    msg.arg1));
                    break;
                // Application unregistration complete.
                case BluetoothHDPService.STATUS_HEALTH_APP_UNREG:
                    mStatusMessage.setText(
                            String.format(mRes.getString(com.vkleiko.runit.R.string.status_unreg),
                                    msg.arg1));
                    break;
                // Reading data from HDP device.
                case BluetoothHDPService.STATUS_READ_DATA:
                    mStatusMessage.setText(mRes.getString(com.vkleiko.runit.R.string.read_data));
                    mDataIndicator.setImageLevel(1);
                    break;
                // Finish reading data from HDP device.
                case BluetoothHDPService.STATUS_READ_DATA_DONE:
                    mStatusMessage.setText(mRes.getString(com.vkleiko.runit.R.string.read_data_done));
                ...
                case BluetoothHDPService.STATUS_CREATE_CHANNEL:
                    mStatusMessage.setText(
                            String.format(mRes.getString(com.vkleiko.runit.R.string.status_create_channel),
                                    msg.arg1));
                    mConnectIndicator.setText(com.vkleiko.runit.R.string.connected);
                    break;
                ...
                case BluetoothHDPService.STATUS_DESTROY_CHANNEL:
                    mStatusMessage.setText(
                            String.format(mRes.getString(com.vkleiko.runit.R.string.status_destroy_channel),
                                    msg.arg1));
                    mConnectIndicator.setText(com.vkleiko.runit.R.string.disconnected);
                    break;
                default:
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vkleiko.runit.R.layout.activity_health_device);
        Toolbar toolbar = (Toolbar) findViewById(com.vkleiko.runit.R.id.toolbar);
        setSupportActionBar(toolbar);

        mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
        if (mBluetoothAdapter == null) {
            Toast.makeText(this, com.vkleiko.runit.R.string.bluetooth_not_available, Toast.LENGTH_LONG);
            finish();
            return;
        }

        mConnectIndicator = (TextView) findViewById(com.vkleiko.runit.R.id.connect_ind);
        mStatusMessage = (TextView) findViewById(com.vkleiko.runit.R.id.status_msg);
        mDataIndicator = (ImageView) findViewById(com.vkleiko.runit.R.id.data_ind);
        mRes = getResources();
        mHealthServiceBound = false;

        // Initiates application registration through {@link BluetoothHDPService}.
        Button registerAppButton = (Button) findViewById(com.vkleiko.runit.R.id.button_register_app);
        ...
        Button unregisterAppButton = (Button) findViewById(com.vkleiko.runit.R.id.button_unregister_app);
        ...
        // to connect to.
        Button connectButton = (Button) findViewById(com.vkleiko.runit.R.id.button_connect_channel);
        connectButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Log.v(TAG, "connectButton onClick()");
                mAllBondedDevices =
        ...
        Button disconnectButton = (Button) findViewById(com.vkleiko.runit.R.id.button_disconnect_channel);
    ...
    public void setDevice(int position) {
        Log.v(TAG, "setDevice() position: " + position);
        mDevice = this.mAllBondedDevices[position];
        mDeviceIndex = position;
    }

    private void connectChannel() {
        Log.v(TAG, "connectChannel()");
    ...
    public static class SelectDeviceDialogFragment extends DialogFragment {
        ...
        public static SelectDeviceDialogFragment newInstance(String[] names, int position) {
            Log.v(TAG, "Dialog newInstance() pos: " + position + " names: " + names.toString());
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            Log.v(TAG, "dialog onCreateDialog");
            String[] deviceNames = getArguments().getStringArray("names");
            int position = getArguments().getInt("position", -1);
            if (position == -1) position = 0;
            return new AlertDialog.Builder(getActivity())
                    .setTitle(com.vkleiko.runit.R.string.select_device)
//                    .setTitle("Select")
//                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {


                    .setPositiveButton( com.vkleiko.runit.R.string.ok,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    Log.v(TAG, "dialog positive button onClick()");
                    ...
                    .setSingleChoiceItems(deviceNames, position,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    Log.v(TAG, "dialog setSingleChoiceItems");
